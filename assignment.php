    ...
    <div class="modal-content">
      ...
      <form class="custom_add_form" method="post" id="addAssignmentForm">
          ...
          <div class="col-md-12">
              <div class="form-group">
                  <label >Submission Date
                      ...
                      <input type="date" name="submission-date" id="submission-date" class="form-control" required>
                  </div>
              </div>
        </div>
        ...
        <div class="custom_add_form form-group col-12">
            ...
            <a href="#" class="btn btn-sm btn-primary float-right add_submit_button" onclick="$('#assignment-file').trigger('click');">Select File</a>
        </div>
        ...
        <div class="form-group col-md-6">
            ...
            <select class="selectpicker custom-select1 col-md-12" id="semester" name="semester">
              <option>1</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
